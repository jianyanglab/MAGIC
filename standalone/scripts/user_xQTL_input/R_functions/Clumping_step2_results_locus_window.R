...
write.table(res, paste0(OUTPUT,"/MAGIC/Clumping/summary/",trait_name,"_",format(2*window_size, scientific = FALSE),".locus"),row=F,col=T,quo=F,sep="\t")
...
write.table(result, paste0(OUTPUT,"/MAGIC/Clumping/summary/",trait_name,"_",format(2*window_size, scientific = FALSE),"_gene.locus"),row=F,col=T,quo=F,sep="\t")
